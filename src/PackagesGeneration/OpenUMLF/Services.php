...
class Services
{
     ...
     * @JMS\Type("Webit\DPDClient\PackagesGeneration\OpenUMLF\Services\DeclaredValue")
     */
     ...
     * @JMS\Type("Webit\DPDClient\PackagesGeneration\OpenUMLF\Services\Guarantee")
     */
    private $guarantee;
     ...
     * @JMS\Type("Webit\DPDClient\PackagesGeneration\OpenUMLF\Services\Cod")
     */
    private $cod;
     ...
     * @JMS\Type("Webit\DPDClient\PackagesGeneration\OpenUMLF\Services\SelfCol")
     */
    private $selfCol;
