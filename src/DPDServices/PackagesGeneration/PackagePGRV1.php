...
class PackagePGRV1
{
     ...
     * @JMS\Type("array<Webit\DPDClient\DPDServices\PackagesGeneration\InvalidFieldPGRV1>")
     */
     ...
     * @JMS\Type("array<Webit\DPDClient\DPDServices\PackagesGeneration\ParcelPGRV1>")
     */
    private $parcels;
