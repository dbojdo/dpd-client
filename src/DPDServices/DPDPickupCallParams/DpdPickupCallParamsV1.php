...
class DpdPickupCallParamsV1
{
    /**
     * @var PolicyDPPEnumV1
     * @JMS\Type("Webit\DPDClient\DPDServices\DPDPickupCallParams\PolicyDPPEnumV1")
     ...
     * @JMS\Type("Webit\DPDClient\DPDServices\DPDServicesParams\PickupAddressDSPV1")
     ...
     * @JMS\Type("Webit\DPDClient\DPDServices\DPDPickupCallParams\ContactInfoDPPV1")
    ...
    /**
     * @var ProtocolDPPV1[]
     * @JMS\Type("array<Webit\DPDClient\DPDServices\DPDPickupCallParams\ProtocolDPPV1>")
