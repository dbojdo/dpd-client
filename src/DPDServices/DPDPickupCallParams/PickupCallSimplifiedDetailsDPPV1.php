...
class PickupCallSimplifiedDetailsDPPV1
{
     ...
     * @JMS\Type("Webit\DPDClient\DPDServices\DPDPickupCallParams\PickupPayerDPPV1")
     ...
     * @JMS\Type("Webit\DPDClient\DPDServices\DPDPickupCallParams\PickupCustomerDPPV1")
     ...
     * @JMS\Type("Webit\DPDClient\DPDServices\DPDPickupCallParams\PickupSenderDPPV1")
     ...
     * @JMS\Type("Webit\DPDClient\DPDServices\DPDPickupCallParams\PickupPackagesParamsDPPV1")
