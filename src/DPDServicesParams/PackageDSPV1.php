<?php
/**
 * File PackageDSPV1.php
 * Created at: 2017-06-12 21:26
 *
...
class PackageDSPV1
{
    ...
    /**
     * @var ParcelDSPV1[]
     * @JMS\Type("array<Webit\DPDClient\DPDServicesParams\ParcelDSPV1>")
     * @JMS\SerializedName("parcels")
     */
    private $parcels;

    /**
     * PackageDSPV1 constructor.
     * @param int $packageId
     * @param string $searchKey
     * @param ParcelDSPV1[] $parcels
     */
    public function __construct($packageId = null, $searchKey, array $parcels = array())
    {
